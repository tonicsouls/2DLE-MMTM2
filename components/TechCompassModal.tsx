...
const TechCompassModal = ({ onClose }: { onClose: () => void }) => {
    useEffect(() => {
        ...
        >
            ...
            >
                <header className="p-4 sm:p-6 flex justify-between items-center border-b border-gray-700 flex-shrink-0">
                    <h2 className="font-montserrat text-2xl font-bold text-white">TechCompass</h2>
                ...
                <div className="p-1 md:p-2 flex-grow bg-gray-800 rounded-b-2xl">
                    <iframe
                        src="https://tech-compass-vd3-1-614326876418.us-west1.run.app"
                        title="Tech Compass AI Assistant"
                        frameBorder="0"
...
export default TechCompassModal;