...
const CareerCatalystModal = ({ onClose }: { onClose: () => void }) => {
    useEffect(() => {
        ...
        >
            ...
            >
                <header className="p-4 sm:p-6 flex justify-between items-center border-b border-gray-700 flex-shrink-0">
                    <h2 className="font-montserrat text-2xl font-bold text-white">Career Catalyst</h2>
                ...
                <div className="p-1 md:p-2 flex-grow bg-gray-800 rounded-b-2xl">
                    <iframe
                        src="https://career-catalyst-version-v6-913-614326876418.us-west1.run.app/"
...
export default CareerCatalystModal;
