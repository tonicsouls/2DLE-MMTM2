...
const FamilyReunionModal = ({ onClose }: { onClose: () => void }) => {
    useEffect(() => {
        ...
        >
            ...
            >
                <header className="p-4 sm:p-6 flex justify-between items-center border-b border-gray-700 flex-shrink-0">
                    <h2 className="font-montserrat text-2xl font-bold text-white">Family Reunion AI Designer</h2>
                ...
                <div className="p-1 md:p-2 flex-grow bg-gray-800 rounded-b-2xl">
                    <iframe
                        src="https://family-reunion-t-shirt-ai-designer-614326876418.us-west1.run.app"
                        title="Family Reunion T-Shirt AI Designer"
                        frameBorder="0"
...
export default FamilyReunionModal;
